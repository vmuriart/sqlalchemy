...
class PolymorphicCircularTest(fixtures.MappedTest):
    ...
    def define_tables(cls, metadata):
        ...
        table1 = Table('table1', metadata,
                       ...
                       Column('related_id', Integer, ForeignKey('table1.id'),
                              nullable=True),
        ...
        table1b_mapper = mapper(Table1B, inherits=table1_mapper,
        ...
        table3_mapper = mapper(Table3, table3, inherits=table1_mapper,
    ...
    def test_three(self):
        self._testlist(
            [Table2, Table1, Table1B, Table3, Table3, Table1B, Table1B, Table2,
             Table1])
