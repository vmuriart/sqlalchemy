    ...
    def test_post_update_m2o(self):
        ...
        self.assert_sql_execution(
            ...
            CompiledSQL("UPDATE person SET favorite_ball_id=:favorite_ball_id "
                        ...
                        lambda ctx: {'favorite_ball_id': p.favorite.id,
                                     'person_id': p.id}
                        ),
        )
